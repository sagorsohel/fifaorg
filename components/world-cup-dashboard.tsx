    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans transition-all duration-300">
      ...
      {showStreamModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-[#050b14] border border-cyan-500/25 rounded-3xl w-full max-w-md overflow-hidden relative shadow-[0_0_60px_rgba(245,158,11,0.18)] z-10 animate-fade-in">
            {/* Header */}
